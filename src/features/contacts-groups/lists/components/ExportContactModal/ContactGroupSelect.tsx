...
const ContactGroupSelect = ({ selectedGroups, onChange }: Props) => {
  ...
  return (
    <>
      <label
        className="!pw-text-left pw-block pw-mt-2 pw-mb-1 pw-text-sm pw-font-semibold"
        htmlFor={t('contact_group') || ''}
      >
        {t('contact_group')}
      </label>
      <Whisper
          ...
          return (
            ...
            >
              ...
              >
                ...
                {list.length > 0 && (
                  <div className="pw-overflow-y-auto pw-overflow-x-hidden pw-h-[32vh]">
