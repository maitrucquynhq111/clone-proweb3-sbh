...
export const productFormSchema = ({
  ...
  const canSettingProduct = useHasPermissions([ProductPermission.PRODUCT_PRODUCTSETTINGS_ALL_VIEW]);
          ...
          children: [
            {
              ...
              onChange: (files: ExpectedAny) => {
                if (
                  ...
                  setOpenUpgrade('product_count_picture');
                  return;
                }
